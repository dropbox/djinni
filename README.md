...
Since the generated headers are including this `support-lib/djinni_common.hpp` header, you must distribute this header together with your library that is using Djinni.

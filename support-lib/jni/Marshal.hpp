...
namespace djinni
{
	...
	public:
		...
		struct Boxed
		{
			...
			static CppType toCpp(JNIEnv* jniEnv, JniType j)
			{
				...
				auto ret = Primitive::toCpp(Self::unbox(jniEnv, data.method_unbox, j));
			...
			{
				const auto& data = JniClass<Self>::get();
				auto ret = jniEnv->CallStaticObjectMethod(data.clazz.get(), data.method_box, Primitive::fromCpp(c));
				jniExceptionCheck(jniEnv);
				return {jniEnv, ret};
			}
		};
	...
	class Bool : public Primitive<Bool, bool, jboolean>
	{
		...
		static auto unbox(JNIEnv* jniEnv, jmethodID method, jobject j) noexcept { return jniEnv->CallBooleanMethod(j, method); }
	};
	...
	class I8 : public Primitive<I8, int8_t, jbyte>
	{
		...
		static auto unbox(JNIEnv* jniEnv, jmethodID method, jobject j) noexcept { return jniEnv->CallByteMethod(j, method); }
	};
	...
	class I16 : public Primitive<I16, int16_t, jshort>
	{
		...
		static auto unbox(JNIEnv* jniEnv, jmethodID method, jobject j) noexcept { return jniEnv->CallShortMethod(j, method); }
	};
	...
	class I32 : public Primitive<I32, int32_t, jint>
	{
		...
		static auto unbox(JNIEnv* jniEnv, jmethodID method, jobject j) noexcept { return jniEnv->CallIntMethod(j, method); }
	};
	...
	class I64 : public Primitive<I64, int64_t, jlong>
	{
		...
		static auto unbox(JNIEnv* jniEnv, jmethodID method, jobject j) noexcept { return jniEnv->CallLongMethod(j, method); }
	};
	...
	class F64 : public Primitive<F64, double, jdouble>
	{
		...
		static auto unbox(JNIEnv* jniEnv, jmethodID method, jobject j) noexcept { return jniEnv->CallDoubleMethod(j, method); }
	};
	...
	public:
		...
		static LocalRef<JniType> fromCpp(JNIEnv* jniEnv, const CppType& c)
		{
			...
			for(const auto& ce : c)
			{
				auto jKey = Key::fromCpp(jniEnv, ce.first);
				auto jValue = Value::fromCpp(jniEnv, ce.second);

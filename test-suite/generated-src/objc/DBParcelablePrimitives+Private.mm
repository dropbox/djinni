...
#import "DBParcelablePrimitives+Private.h"
#import "DJIMarshal+Private.h"
#include <cassert>

namespace djinni_generated {

auto ParcelablePrimitives::toCpp(ObjcType obj) -> CppType
{
    assert(obj);
    return {::djinni::Bool::toCpp(obj.b),
            ...
            ::djinni::Optional<std::experimental::optional, ::djinni::String>::toCpp(obj.oS),
            ::djinni::Optional<std::experimental::optional, ::djinni::Date>::toCpp(obj.oD)};
}

auto ParcelablePrimitives::fromCpp(const CppType& cpp) -> ObjcType
{
    return [[DBParcelablePrimitives alloc] initWithB:(::djinni::Bool::fromCpp(cpp.b))
                                         ...
                                         oFsixtyfour:(::djinni::Optional<std::experimental::optional, ::djinni::F64>::fromCpp(cpp.o_fsixtyfour))
                                                  oS:(::djinni::Optional<std::experimental::optional, ::djinni::String>::fromCpp(cpp.o_s))
                                                  oD:(::djinni::Optional<std::experimental::optional, ::djinni::Date>::fromCpp(cpp.o_d))];
}

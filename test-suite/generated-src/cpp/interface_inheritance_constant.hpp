...
public:
    virtual ~InterfaceInheritanceConstant() {}
     ...
     */
    virtual const std::string jniProxyClassName() { return "com/dropbox/djinni/test/InterfaceInheritanceConstant$CppProxy"; }
     ...
     */
    virtual const std::string objcProxyClassName() { return "DBInterfaceInheritanceConstantCppProxy"; }

    static std::string const BASE_METHOD_RETURN_VALUE;

    static std::string const BASE_OVERRIDE_METHOD_RETURN_VALUE;

    static std::string const SUB_METHOD_RETURN_VALUE;

    static std::string const SUB_OVERRIDE_METHOD_RETURN_VALUE;
};

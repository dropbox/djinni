...
class SubObjcJavaInterfaceInheritance : public BaseObjcJavaInterfaceInheritance {
public:
    virtual ~SubObjcJavaInterfaceInheritance() {}
     ...
     */
    virtual const std::string objcProxyClassName() { return "DBSubObjcJavaInterfaceInheritance"; }

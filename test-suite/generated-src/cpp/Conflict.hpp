...
public:
     ...
     */
    virtual const std::string jniProxyClassName() { return "com/dropbox/djinni/test/Conflict$CppProxy"; }
     ...
     */
    virtual const std::string objcProxyClassName() { return "DBConflict"; }
};

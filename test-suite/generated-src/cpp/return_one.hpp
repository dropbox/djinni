...
public:
     ...
     */
    virtual const std::string jniProxyClassName() { return "com/dropbox/djinni/test/ReturnOne$CppProxy"; }
     ...
     */
    virtual const std::string objcProxyClassName() { return "DBReturnOne"; }

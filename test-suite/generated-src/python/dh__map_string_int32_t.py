...
class MapStringInt32THelper:
    c_data_set = MultiSet()

    @staticmethod
    def check_c_data_set_empty():
        assert len(MapStringInt32THelper.c_data_set) == 0

    @ffi.callback("int32_t(struct DjinniObjectHandle *, struct DjinniString *)")
    ...
    def __delete(c_ptr):
        assert c_ptr in MapStringInt32THelper.c_data_set

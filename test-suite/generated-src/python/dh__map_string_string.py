...
class MapStringStringHelper:
    c_data_set = MultiSet()

    @staticmethod
    def check_c_data_set_empty():
        assert len(MapStringStringHelper.c_data_set) == 0
    ...
    def __delete(c_ptr):
        assert c_ptr in MapStringStringHelper.c_data_set
        MapStringStringHelper.c_data_set.remove(c_ptr)
    ...
    @staticmethod
    def _add_callbacks():
        lib.map_string_string_add_callback__get_value(MapStringStringHelper.__get_value)
        lib.map_string_string_add_callback___delete(MapStringStringHelper.__delete)
        lib.map_string_string_add_callback__get_size(MapStringStringHelper.__get_size)
        lib.map_string_string_add_callback__python_create(MapStringStringHelper.__python_create)
        lib.map_string_string_add_callback__python_add(MapStringStringHelper.__python_add)
        lib.map_string_string_add_callback__python_next(MapStringStringHelper.__python_next)

MapStringStringHelper._add_callbacks()

class MapStringStringProxy:
    def iter(d):
        for k in d:
            yield k

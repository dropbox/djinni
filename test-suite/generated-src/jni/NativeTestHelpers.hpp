...
class NativeTestHelpers final : ::djinni::JniInterface<::djinni_generated::TestHelpers, NativeTestHelpers>
{
public:
    using CppType = std::shared_ptr<::djinni_generated::TestHelpers>;
...
private:
    ...
    friend ::djinni::JniInterface<::djinni_generated::TestHelpers, NativeTestHelpers>;

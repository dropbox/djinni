...
NativeClientInterface::NativeClientInterface() : djinni::JniInterface<::djinni::cpp::ClientInterface, NativeClientInterface>() {}

NativeClientInterface::JavaProxy::JavaProxy(jobject obj) : JavaProxyCacheEntry(obj) {}

::djinni::cpp::ClientReturnedRecord NativeClientInterface::JavaProxy::JavaProxy::get_record(int64_t c_record_id, const std::string & c_utf8string) {
    ...
    const auto & data = djinni::JniClass<::djinni::jni::NativeClientInterface>::get();

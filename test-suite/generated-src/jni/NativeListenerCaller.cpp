...
CJNIEXPORT jobject JNICALL Java_com_dropbox_djinni_test_ListenerCaller_00024StaticNativeMethods_init(JNIEnv* jniEnv, jobject /*this*/, jobject j_firstL, jobject j_secondL)
{
    try {

...
CJNIEXPORT jobject JNICALL Java_com_dropbox_djinni_test_FlagRoundtrip_00024StaticNativeMethods_roundtripAccess(JNIEnv* jniEnv, jobject /*this*/, jobject j_flag)
{
    try {
...
CJNIEXPORT jobject JNICALL Java_com_dropbox_djinni_test_FlagRoundtrip_00024StaticNativeMethods_roundtripEmpty(JNIEnv* jniEnv, jobject /*this*/, jobject j_flag)
{
    try {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);
...
CJNIEXPORT jobject JNICALL Java_com_dropbox_djinni_test_FlagRoundtrip_00024StaticNativeMethods_roundtripAccessBoxed(JNIEnv* jniEnv, jobject /*this*/, jobject j_flag)
{
    try {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);
...
CJNIEXPORT jobject JNICALL Java_com_dropbox_djinni_test_FlagRoundtrip_00024StaticNativeMethods_roundtripEmptyBoxed(JNIEnv* jniEnv, jobject /*this*/, jobject j_flag)
{
    try {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);

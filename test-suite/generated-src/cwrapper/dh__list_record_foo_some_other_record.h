...
void list_record_foo_some_other_record___delete(struct DjinniObjectHandle *);
void optional_list_record_foo_some_other_record___delete(struct DjinniOptionalObjectHandle *);
